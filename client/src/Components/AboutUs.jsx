...
const AboutUs = () => {
  return (
<div className='flex'>
  <section class="bg-white dark:bg-gray-900 text-center text-white">
    <div class="mt-20 mx-auto">
       <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-orange-500 md:text-5xl lg:text-6xl dark:text-orange-500">Welcome to our culinary journey </h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-100">
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 text-white">
      <div class="max-w-screen-md mb-8 lg:mb-16 mx-auto my-auto">
          <h2 class="mb-4 text-4xl tracking-tight font-mediumbold text-gray-900 dark:text-white">Our Services</h2>
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <div class="flex-grow">
                <h2 class="text-white text-lg title-font font-medium mb-3"> Effortless Ordering</h2>
          ...
          <div>
            ...
            <div class="flex-grow">
             <h2 class="text-white text-lg title-font font-medium mb-3"> Dedicated Delivery Personnel</h2>
          ...
          <div>
            ...
            <div class="flex-grow">
              <h2 class="text-white text-lg title-font font-medium mb-3"> Restaurant Partnerships</h2>
          ...
          <div>
            ...
            <div class="flex-grow">
              <h2 class="text-white text-lg title-font font-medium mb-3">Favourite Food Clicks Away</h2>
          ...
          <div>
             ...
             <div class="flex-grow">
               <h2 class="text-white text-lg title-font font-medium mb-3"> Become a Delivery Partner</h2>
          ...
          <div>
             ...
             <div class="flex-grow">
               <h2 class="text-white text-lg title-font font-medium mb-3"> Secure and Convenient Transactions</h2>
  ...
  <div class="mb-20">
      <a href="#">
        <button class="px-10 py-3 mr-8 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-orange-500 rounded-lg hover:bg-orange-400 focus:outline-none focus:ring focus:ring-orange-300 focus:ring-opacity-50">
         To explore more tastes
        </button>
      </a> 
      <a href="#">
        <button class="px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-orange-500 rounded-lg hover:bg-orange-400 focus:outline-none focus:ring focus:ring-orange-300 focus:ring-opacity-50">
          To register as delivery boy
        </button>
      </a>
  </div>
  <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
          <h2 class="mb-4 text-4xl tracking-tight font-mediumbold text-gray-900 dark:text-white">Featured In</h2>
          <div class="flex mt-6 justify-center">
            <div class="w-16 h-1 rounded-full bg-orange-500 inline-flex"></div>
          </div>
