...
const ContactUs = () => {
 ...
 <section class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-12 mx-auto">
        <div>
            <h1 class="mt-2 text-3xl py-4 font-semibold text-orange-500 md:text-3xl dark:text-orange-300">Chat to our friendly team</h1>
        ...
        <div class="grid grid-cols-1 gap-12 mt-20 lg:grid-cols-2">
            <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2">
                <div>
                    <span class="inline-block p-3 text-orange-500 rounded-full bg-orange-100/80 dark:bg-gray-800">
                    ...
                    <p class="mt-2 text-sm text-orange-500 dark:text-orange-400">foodcart@gmail.com</p>
                </div>
