...
import { Delivery, HeroBg, deliveryBoy } from "../assets";
        ...
        <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 ">
          <div className="flex flex-col items-start justify-start gap-6">
            ...
            <p className="text-textColor text-lg">
              We are ready to deliver the best food in your city in just 30
              minutes The best Quality food available at a single click . What
        ...
        <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 ">
          <div className="flex flex-col items-start justify-start gap-6">
            ...
            <p className="text-[40px] text-headingColor md:text-[60px] font-sans font-extrabold tracking-wider">
              Join Us to Deliver The Best Food in{" "}
              <span className="text-orange-600">Your City</span>
            </p>

            <p className="text-textColor text-lg">
              Join us ! in the path to become the best restaurant with fastest
              delivery services with the promise for food being delivered under
              30 min.
            </p>
            <Link
              {...buttonClick}
