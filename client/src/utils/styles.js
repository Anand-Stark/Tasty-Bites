export const isActiveStyles =
  " text-2xl shadow-lg bg-lightOverlay text-red-700 font-semibold hover:text-red-700 px-4 py-2 duration-100 transition-all ease-in-out";
...
export const statuses = [
  ...
  { id: 7, title: "Italian", category: "italian" },
];
